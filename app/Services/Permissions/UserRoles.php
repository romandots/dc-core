...
class UserRoles
{
    ...
    public const ADMIN_PERMISSIONS = [
        ...
        ProfilesPermissions::MANAGE_PROFILES,
        ProfilesPermissions::CREATE_PROFILES,
        ProfilesPermissions::READ_PROFILES,
        ProfilesPermissions::UPDATE_PROFILES,
        ProfilesPermissions::DELETE_PROFILES,
